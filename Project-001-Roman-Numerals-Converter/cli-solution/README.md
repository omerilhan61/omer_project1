...
pip3 install flask
cd /home/ec2-user
FOLDER="https://raw.githubusercontent.com/omerilhan61/omer_project1/main/Project-001-Roman-Numerals-Converter/"
wget ${FOLDER}/app.py
...
```bash
aws ec2 run-instances --image-id $LATEST_AMI --count 1 --instance-type t2.micro --key-name first-key-pair --security-group-ids sg-017a9bef9e47bb024 --tag-specifications 'ResourceType=instance,Tags=[{Key=Name,Value=roman_numbers}]' --user-data file:///home/ec2-user/userdata.sh
or
...
aws ec2 run-instances \
    ...
    --security-group-ids sg-017a9bef9e47bb024 \
...
```bash
aws ec2 terminate-instances --instance-ids i-019fb340522c4b9f2 <We have already learned this id with query on above>
```
